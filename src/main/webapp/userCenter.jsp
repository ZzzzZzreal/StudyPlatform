...
<table border="1" align="left" cellspacing="10" >
    ...
    <tr>
        ...
        <td align="center"><img src="${pageContext.request.contextPath}/upload/${photo}"
                 width="130px" height="100px"></td></tr>

    <tr><td><a href="${pageContext.request.contextPath}/upImg.jsp">上传/修改头像</a></td>${img2}</tr>
    <tr><td><a href="${pageContext.request.contextPath}/userinfo">查看/修改个人信息</a></td>${msg} ${userinfo}</tr>
    <tr><td><a href="${pageContext.request.contextPath}/coinServlet">我的钱包</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/myTracks.jsp">我的足迹</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/mycourse">我的课程表</a></td></tr>
    <tr><td>成绩查询</td></tr>
    <tr><td>课程评价</td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/signin">签到</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/complaint">意见反馈</a></td>${msa}</tr>
