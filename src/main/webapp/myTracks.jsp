...
<table border="1" align="left" cellspacing="10" >
    <tr><td><a href="${pageContext.request.contextPath}/myCollection">我的收藏</a></td>${msg}</tr>
    <tr><td><a href="${pageContext.request.contextPath}/myUpload">我的上传</a></td>${mse}</tr>
    <tr><td><a href="${pageContext.request.contextPath}/myDownload">我的下载</a></td>${msa}</tr>
