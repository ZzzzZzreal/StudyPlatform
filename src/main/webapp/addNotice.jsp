...
<%--以上是每个页面都有的内容--%>
<form action="${pageContext.request.contextPath}/addNotice" method="post" name="addNotice">
    ...
    <table border="3" align="center">
        ...
        <form action="${pageContext.request.contextPath}/addNotice" method="post" name="addNotice">
            <tr>
                ...
                <td><textarea name="n_title" id="n_title" rows="1" cols="50"></textarea> </td>
            </tr>
            <tr>
                <td align="center">内容:</td>
                <td><textarea name="n_content" id="n_content" rows="10" cols="50"></textarea></td>
            </tr>
            <tr>
                <th align="center" colspan="2">
                    <input type="submit" value="发布"></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="reset" value="重置" /><br/> &nbsp;&nbsp;&nbsp;&nbsp;${msg.note}${notice.note}</th>
            </tr>
        </form>
    </table>
