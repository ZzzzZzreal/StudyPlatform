...
<table border="3">
    ...
    <c:forEach items="${upLoad}" var="p">
        <tr>
            <td align="center"><a href="${pageContext.request.contextPath}/details?r_id=${p.r_id}">${p.r_name}</a></td>
            <td align="center" id="r_major">${p.major}</td>
            <td align="center" id="r_type">${p.r_type}</td>
            <td align="center" id="filesize">${p.filesize}</td>
            <td align="center" id="r_time">${p.r_uptime}</td>
            <td align="center">
                <a href="${pageContext.request.contextPath}/delMyUpload?r_id=${p.r_id}">删除</a>
            </td>
        </tr>
    </c:forEach>
