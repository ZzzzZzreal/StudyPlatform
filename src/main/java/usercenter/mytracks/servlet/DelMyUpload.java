...
public class DelMyUpload extends HttpServlet{
...
//            e.printStackTrace();
        ...
        System.out.println("DelUploadServlet 用户id："+u_id);
        System.out.println("DelUploadServlet 资源id："+r_id);


        //创建MyTracksService对象
        MyTracksService myTracksService = new MyTracksService();
        //调用doDelMyDownload方法
        myTracksService.doDelMyUpload(r_id,u_id);
        //响应值
